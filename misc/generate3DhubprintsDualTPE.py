...
# consts
outer_cut_depth = 2  # For nang head seating
inner_cut_depth = 1  # For screw head seating
wiggle = 0.2  # Planar slab edges incident on cones (for the nang shells)
edge_diam = 2  # For edge thickness
shell_cylinder_rad = 2.5
bulb_stem_diameter = 34

toothpick_diameter = 2.2  # Used for polar hole.  Originally 2.15
...
nang_ball_core(sphere_radius=50, class_pattern=[3, 3, 1])
